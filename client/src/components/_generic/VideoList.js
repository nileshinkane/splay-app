    ...
    <SideComponent>
      <div>
        <SearchBox
          ...
          placeholder="Search a video in database"
        />
        {videos.length !== 0 && (
          <InfiniteScroll
                  ...
                  {isAuthenticated() && (
                    <div className={classes.editStyles}>
                      ...
                      <Button
                        ...
                        onClick={(e) => handleDialog(e, current._id)}
                        size="small"
                      >
                        Delete
                      </Button>
        ...
        {dialog ? (
          <DialogBox
            ...
            data="Are you sure you want to delete this video ?"
            continue={deleteVideo}
          />
        ) : (
          ""
        )}
